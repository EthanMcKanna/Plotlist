...
export type HomeEditorialResearchSourceId =
  ...
  | "netflix_i_will_find_you_series"
  | "disney_plus_xmen_97_series"
  | "apple_tv_silo_series"
  | "paramount_plus_the_agency_series"
...
> = {
  ...
  netflix_i_will_find_you_series: {
    label: "Netflix Tudum I Will Find You",
    url: "https://www.netflix.com/tudum/articles/i-will-find-you-harlan-coben-series",
    checkedAt: "2026-07-02",
  },
  disney_plus_xmen_97_series: {
    label: "Marvel X-Men '97 series page",
    url: "https://www.marvel.com/tv-shows/x-men-97/1",
    checkedAt: "2026-07-02",
  },
  apple_tv_silo_series: {
    label: "Apple TV Silo series page",
    url: "https://tv.apple.com/us/show/silo/umc.cmc.3yksgc857px0k0rqe5zd4jice",
    checkedAt: "2026-07-02",
  },
  paramount_plus_the_agency_series: {
    label: "Paramount+ The Agency series page",
...
const HOME_EDITORIAL_SEED_ITEMS: Record<string, HomeEditorialSeedItem> = {
  ...
  "I Will Find You": {
    ...
    tmdbVoteCount: 177,
    externalSource: "tmdb",
    tmdbPopularity: 137.9621,
    tmdbVoteAverage: 8.282,
    homeSignal: "Netflix Jun 18",
    editorialTier: "verified_current",
  },
  "X-Men '97": {
    year: 2024,
    ...
    posterUrl: "https://image.tmdb.org/t/p/w500/yI3skmBTiworOlwAzuD4haCTF60.jpg",
    externalId: "138502",
    backdropUrl: "https://image.tmdb.org/t/p/w1280/vY7Fap4aYz7e4Dk5MwhKdR0GmKR.jpg",
    tmdbVoteCount: 701,
    externalSource: "tmdb",
    tmdbPopularity: 81.7796,
    tmdbVoteAverage: 8.544,
    homeSignal: "S2 airing now",
    editorialTier: "verified_current",
  },
  Silo: {
    year: 2023,
    ...
    posterUrl: "https://image.tmdb.org/t/p/w500/fDMTqUcEh6qJwWZP1SHTfoaqsCy.jpg",
    externalId: "125988",
    backdropUrl: "https://image.tmdb.org/t/p/w1280/uTWhbLc7Bj4qNSdW3ZvZKL8cOHv.jpg",
    tmdbVoteCount: 2130,
    externalSource: "tmdb",
    tmdbPopularity: 84.0959,
    tmdbVoteAverage: 8.164,
    homeSignal: "S3 airing now",
    editorialTier: "verified_current",
  },
  "The Agency": {
    ...
    posterUrl: "https://image.tmdb.org/t/p/w500/zoLZbm5gtTQurjMxp5VOdHIpMmz.jpg",
    externalId: "219971",
    backdropUrl: "https://image.tmdb.org/t/p/w1280/9itOpkXcVrJDlGvRDMaLjUdTwrs.jpg",
    tmdbVoteCount: 236,
    externalSource: "tmdb",
    tmdbPopularity: 68.6102,
    tmdbVoteAverage: 7.1,
    homeSignal: "S2 finale Jun 21",
    editorialTier: "verified_current",
  },
};
...
const HOME_EDITORIAL_PROVIDER_SEED_TITLES: Record<HomeEditorialProviderKey, string[]> = {
  ...
  paramount_plus: ["Dutton Ranch", "The Madison", "The Agency"],
...
const HOME_EDITORIAL_SEED_WINDOWS: Record<string, HomeEditorialSeedWindow> = {
  ...
  "Maximum Pleasure Guaranteed": { validThrough: "2026-07-12" },
  ...
  "World War II with Tom Hanks": { validFrom: "2026-06-01", validThrough: "2026-07-12" },
  ...
  "I Will Find You": { validThrough: "2026-07-12" },
  "X-Men '97": { validThrough: "2026-07-12" },
  Silo: { validThrough: "2026-07-12" },
  "The Agency": { validThrough: "2026-07-12" },
};
...
const HOME_EDITORIAL_OFFICIAL_SOURCE_BY_TITLE: Record<string, HomeEditorialResearchSourceId> = {
  ...
  "I Will Find You": "netflix_i_will_find_you_series",
  "X-Men '97": "disney_plus_xmen_97_series",
  Silo: "apple_tv_silo_series",
  "The Agency": "paramount_plus_the_agency_series",
};
...
const HOME_EDITORIAL_PLATFORM_BY_TITLE: Record<string, HomeEditorialPlatformKey> = {
  ...
  "X-Men '97": "disney_plus",
  Silo: "apple_tv",
  "The Agency": "paramount_plus",
};
...
> = {
  justwatch_us_daily_streaming_charts_jul2: 40,
...
const HOME_EDITORIAL_SEED_PROVENANCE: Record<string, HomeEditorialSeedProvenance> = {
  ...
  "Widow's Bay": {
    ...
    note: "Apple TV+ mystery-comedy with Reelgood and JustWatch US top-chart signals plus weekly-episode momentum; still #1 on the July 2 JustWatch daily chart.",
  },
  "The Pitt": {
    researchedAt: "2026-05-28",
  ...
  Elle: {
    ...
    note: "Prime Video's July 1 Legally Blonde prequel extends the late-window current-demand mix with official trailer proof, premiere-calendar validation, and a launch-day JustWatch daily top-10 debut.",
  },
  "Deli Boys": {
    researchedAt: "2026-05-28",
    rationale: "current_demand",
  ...
  "The Bear": {
    ...
    note: "FX/Hulu final-season return with an official June 25 watch guide, same-month Hulu watchlist demand, and a JustWatch daily top-2 slot after the season five premiere.",
  },
  "Lord of the Flies": {
    researchedAt: "2026-05-28",
    rationale: "current_demand",
  ...
  "House of the Dragon": {
    ...
    note: "June 21 HBO tentpole return now airing weekly and holding a JustWatch daily US top-5 slot.",
  },
  "Rick and Morty": {
    researchedAt: "2026-05-28",
    rationale: "current_demand",
  ...
  "I Will Find You": {
    ...
    note: "Harlan Coben's June 18 Netflix thriller is holding a JustWatch daily US TV top-3 slot two weeks after launch, with official Tudum launch proof.",
  },
  "X-Men '97": {
    researchedAt: "2026-07-02",
    rationale: "current_demand",
    ...
    note: "Disney+ animated revival added from the July 2 JustWatch daily TV top 10 while season two episodes air weekly, with an official Marvel series surface.",
  },
  Silo: {
    researchedAt: "2026-07-02",
    rationale: "current_demand",
    ...
    note: "Apple TV+ dystopian flagship re-entered the JustWatch daily US top 10 as new season-three episodes stream weekly, with an official Apple TV series page.",
  },
  "The Agency": {
    researchedAt: "2026-07-02",
    rationale: "current_demand",
    ...
    note: "Paramount+ with Showtime spy drama added from the July 2 JustWatch daily TV top 10 on season-two finale demand, with an official Paramount+ series page.",
  },
};
